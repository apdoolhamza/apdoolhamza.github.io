...
GROUP ASSIGNMENT (EVEN NUMBER GROUP) - "My Hometown" (Kano)

GROUP MEMBERS AND PAGE ASSIGNMENTS
-----------------------------------
1) Name: ABDULMAJID HAMZA | Reg No: CST/25/SWE/00402 | Page: Home (index.html)
...
about.html - About Us page (CSS Grid layout, team portfolio)
gallery.html - Gallery page (Flexbox layout, 4 captioned images)
table.html - Visitor info table (thead/tbody, rowspan + colspan)
form.html - Trip request form (CSS Grid layout)
style.css - Single shared stylesheet for all pages
images/ - SVG graphic and images used across the site.